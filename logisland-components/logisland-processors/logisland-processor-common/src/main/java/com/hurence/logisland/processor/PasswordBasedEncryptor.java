...
public class PasswordBasedEncryptor implements Encryptor {
    ...
    private class DecryptCallback implements StreamCallback {
        ...
        public void process(final InputStream in, final OutputStream out) throws IOException {
            ...
            try {
                ...
                if (cipherProvider instanceof com.hurence.logisland.processor.NiFiLegacyCipherProvider/*org.apache.nifi.security.util.crypto.NiFiLegacyCipherProvider*/) {
                    salt = ((com.hurence.logisland.processor.NiFiLegacyCipherProvider/*org.apache.nifi.security.util.crypto.NiFiLegacyCipherProvider*/) cipherProvider).readSalt(encryptionMethod, in);
                } else {
                    salt = cipherProvider.readSalt(in);
                }
            } catch (final EOFException e) {
                throw new ProcessException1("Cannot decrypt because file size is smaller than salt size", e);
            }
    ...
    private class EncryptCallback implements StreamCallback {
        ...
        public void process(final InputStream in, final OutputStream out) throws IOException {
            ...
            // NiFi legacy code determined the salt length based on the cipher block size
            if (cipherProvider instanceof com.hurence.logisland.processor.NiFiLegacyCipherProvider/*org.apache.nifi.security.util.crypto.NiFiLegacyCipherProvider*/) {
                salt = ((com.hurence.logisland.processor.NiFiLegacyCipherProvider/*org.apache.nifi.security.util.crypto.NiFiLegacyCipherProvider*/) cipherProvider).generateSalt(encryptionMethod);
            } else {
